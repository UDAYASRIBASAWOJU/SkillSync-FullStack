...
| `SameSite`  | `None`        | Required for cross-subdomain cookies (api.udayasri.dev â†’ skillsync.udayasri.dev) |
| `Domain`    | `.udayasri.dev`  | Shared across all subdomains |
...
For production domain deployments (`https://skillsync.udayasri.dev`):
