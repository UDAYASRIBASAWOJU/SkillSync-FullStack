...
public class EmailService {
  ...
  @Value("${spring.mail.username:udayasribasawoju@gmail.com}")
  private String fromEmail;

  @Value("${app.base-url:https://skillsync.udayasri.dev}")
                ...
                <table role="presentation" width="100%%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
                  ...
                  <tr>
                    <td style="padding:0 24px 24px 24px;">
                      ...
                      <p style="margin:0;font-size:12px;color:#94a3b8;">SkillSync Support • support@skillsync.udayasri.dev</p>
                    </td>
                  </tr>
                </table>
              </td>
